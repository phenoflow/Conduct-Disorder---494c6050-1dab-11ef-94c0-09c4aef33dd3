...
codes = [{"code":"E2C4z","system":"readv2"},{"code":"Eu92z","system":"readv2"},{"code":"Eu92.","system":"readv2"},{"code":"E2C4.","system":"readv2"},{"code":"F92.9","system":"readv2"},{"code":"F92","system":"readv2"}];
REQUIRED_CODES = 1;
